...
**Version:** 3.0  
**Estado:** Version supersedida por `ESPECIFICACION_DE_REQUERIMIENTOS_v3.1.md`  
**Fecha:** 2026-05-06  
**Autor:** Codex, a partir de la especificacion v2.0/v2.1, la auditoria del estado actual del repositorio y las decisiones funcionales validadas en esta conversacion

> Documento supersedido. La version vigente es [ESPECIFICACION_DE_REQUERIMIENTOS_v3.1.md](c:/Users/mcros/Documents/obfuscator/ESPECIFICACION_DE_REQUERIMIENTOS_v3.1.md).
