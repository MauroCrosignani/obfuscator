...
![](capturas/02-dataset-cargado.png){fig-alt="Pantalla principal de ObfuscatoR con un dataset cargado" width="84%"}

- Carga de dataset y lectura del esquema.
- Clasificación principal por variable y por riesgo.
- Medidor preliminar y guía breve de trabajo.
- Flujo visible de liberación controlada.
...
![](capturas/03-tabla-y-ficha-variable.png){fig-alt="Tabla principal por variable y ficha lateral de detalle" width="82%"}

- Cada variable tiene un rol principal visible.
- La tabla permite revisar rápido.
- La ficha por variable explica:
  - por qué se sugirió ese rol;
  - qué tratamiento técnico se propone;
  - y qué impacto tiene en la liberación.
...
![](capturas/04-resultado-y-auditoria.png){fig-alt="Resultado ofuscado y resumen de auditoría" width="82%"}
