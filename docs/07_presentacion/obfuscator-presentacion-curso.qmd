...
![](capturas/02a-estado-mvp-recorte.png){fig-alt="Vista principal del MVP con dataset cargado, medidor, parámetros y resumen de clasificación" width="92%"}

- Carga de dataset y lectura del esquema.
- Medidor preliminar y clasificación inicial visible.
- Flujo de liberación controlada desde la pantalla principal.
...
![](capturas/03a-clasificacion-riesgo-recorte.png){fig-alt="Tabla principal por variable y ficha de detalle para una variable clasificada como cuasi-identificadora" width="86%"}

- Cada variable tiene un rol principal visible.
- La tabla permite revisar rápido.
- La ficha explica motivo, tratamiento e impacto.
...
![](capturas/04a-resultado-auditoria-recorte.png){fig-alt="Vista previa del resultado ofuscado y resumen de auditoría resultante" width="88%"}

- Resultado transformado.
- Resumen de auditoría legible.
- Estado final de liberación.
- Posibilidad de bloquear, advertir o habilitar según el caso.

::: notes
Esta captura muestra el corazón del MVP.

La herramienta no se queda en “ya transformé columnas”. Devuelve un resultado y además una explicación operativa: qué se hizo, bajo qué criterio, y cuál es el estado final.

Ese resumen de auditoría me parece clave porque traduce decisiones técnicas a una conclusión revisable. No reemplaza el criterio humano ni la política institucional, pero ordena mucho mejor la conversación.
:::
...
- Si la institución quiere usar mejor la IA, necesita algo más que entusiasmo.
- Necesita método, criterios y herramientas que conviertan ese método en práctica.
...
No es una solución final, pero sí una demostración de que un enfoque metodológico serio puede producir herramientas que no se quedan en el papel.
:::
